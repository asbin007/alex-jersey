        ...
        <div className="product-shine relative overflow-hidden bg-[#0d0d0d]" style={{ aspectRatio: '3/4' }}>
          ...
          {avail.length > 0 ? (
            <button
              ...
              className={`absolute bottom-2 right-2 flex h-8 w-8 items-center justify-center rounded-lg transition-all duration-200 sm:bottom-3 sm:right-3 sm:h-9 sm:w-9 sm:rounded-xl sm:translate-y-2 sm:opacity-0 sm:group-hover:translate-y-0 sm:group-hover:opacity-100 ${
                added
