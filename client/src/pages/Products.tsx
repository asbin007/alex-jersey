...
const nations = [
  ...
  'England', 'Germany', 'Netherlands', 'Morocco', 'Colombia', 'USA',
]
const sizes: Size[] = ['S', 'M', 'L', 'XL', 'XXL']

/* ── Filter panel — lifted outside Products to avoid re-creating on render ── */
    ...
    <>
      ...
      <div className="mb-5">
        ...
        <div className="space-y-1">
          {[
            ...
            <button
              key={jt.v}
              onClick={() => onTypeChange(jt.v as JerseyType | '')}
              className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${
                type === jt.v
                  ? 'text-[#FFD700] font-bold bg-[#FFD700]/5'
                  : 'text-[#555] hover:text-white hover:bg-white/5'
      ...
      <div>
        ...
        <input
          ...
          step={100}
          value={maxP}
          onChange={e => onMaxPChange(Number(e.target.value))}
      ...
      <SEO
        title={
          limited
            ...
            : team
            ? `${team} Jerseys - World Cup 2026`
            : 'All Jerseys'
        }
        description={
          limited
            ? 'Exclusive limited edition FIFA World Cup 2026 jerseys. Grab yours before they sell out!'
            : team
            ? `Shop ${team} FIFA World Cup 2026 jerseys. Cash on Delivery across Nepal.`
            : 'Premium FIFA World Cup 2026 jerseys for all 48 nations. Cash on Delivery available across Nepal.'
        }
        keywords={`FIFA World Cup 2026, football jerseys, soccer kits${
          team ? `, ${team}` : ''
        }, Nepal, Cash on Delivery, WhatsApp order`}
        url={`/products${team ? `?team=${team}` : ''}`}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <div className="flex gap-2 sm:gap-3 mb-5">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 sm:px-4 py-3 rounded-xl border text-sm font-bold transition-all flex-shrink-0 ${
                showFilters || hasFilter
                  ? 'border-[#FFD700]/50 text-[#FFD700] bg-[#FFD700]/5'
                  : 'border-[#1f1f1f] text-[#555] bg-[#0a0a0a] hover:border-[#333] hover:text-white'
              }`}
            >
